...
fn ready_fa_local_admits_pdf_text_worker_when_requested() {
    ...
    envelope
        ...
        .worker_types
        .push(GnatWorkerType::PdfTextSyntax);
    envelope
        .plan
        .shards
        .push(fa_local::integrations::cortex::GnatDispatchShard {
    ...
    assert!(
        admission
            ...
            .contains(&GnatWorkerType::PdfTextSyntax)
    );
}
...
fn ready_fa_local_admits_docx_text_worker_when_requested() {
    ...
    envelope
        .required_capabilities
        .worker_types
        .push(GnatWorkerType::DocxTextSyntax);
    envelope
        .plan
        .shards
        .push(fa_local::integrations::cortex::GnatDispatchShard {
    ...
    assert!(
        admission
            .admitted_worker_types
            .contains(&GnatWorkerType::DocxTextSyntax)
    );
}
...
fn ready_fa_local_admits_rtf_text_worker_when_requested() {
    ...
    envelope
        .required_capabilities
        .worker_types
        .push(GnatWorkerType::RtfTextSyntax);
    envelope
        .plan
        .shards
        .push(fa_local::integrations::cortex::GnatDispatchShard {
    ...
    assert!(
        admission
            .admitted_worker_types
            .contains(&GnatWorkerType::RtfTextSyntax)
    );
}
...
fn ready_fa_local_admits_odt_text_worker_when_requested() {
    ...
    envelope
        .required_capabilities
        .worker_types
        .push(GnatWorkerType::OdtTextSyntax);
    envelope
        .plan
        .shards
        .push(fa_local::integrations::cortex::GnatDispatchShard {
    ...
    assert!(
        admission
            .admitted_worker_types
            .contains(&GnatWorkerType::OdtTextSyntax)
    );
}
...
fn ready_fa_local_admits_epub_text_worker_when_requested() {
    ...
    envelope
        .required_capabilities
        .worker_types
        .push(GnatWorkerType::EpubTextSyntax);
    envelope
        .plan
        .shards
        .push(fa_local::integrations::cortex::GnatDispatchShard {
    ...
    assert!(
        admission
            .admitted_worker_types
            .contains(&GnatWorkerType::EpubTextSyntax)
    );
}
